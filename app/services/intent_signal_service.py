...
class IntentSignalService(BaseService[IntentSignal, IntentSignalRepository]):
    ...
    def create(self, organization_id: str, **values: Any) -> IntentSignal:
    ...
    def list_by_type(self, signal_type: str, *, organization_id: str, limit: int = 100) -> Sequence[IntentSignal]:
        ...
        def operation(session: Session) -> Sequence[IntentSignal]:
            return self._repository(session).list_by_type(signal_type, organization_id=organization_id, limit=limit)
